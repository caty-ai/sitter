...
run_test() {
  ...
  (
    set -e
    case $name in
      ledger_replay_equivalence|ledger_sweep_equivalence|ledger_sweep_control_byte_equivalence|ledger_sweep_control_byte_equivalence_no_iconv|ledger_sweep_exported_locale_equivalence)
        set -E
